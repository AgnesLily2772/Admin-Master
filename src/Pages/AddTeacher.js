...
const AddTeacher = () => {
  ...
  return (
    ...
    <label htmlFor="inputEmail3" className="col-sm-2 col-form-label form-label form-label">Name</label>
    <div className="col-sm-10">
      <input type="text" name='name' className="form-control" id="inputEmail3" placeholder="Name" onChange={handleInput}/>
    </div>
  </div>
  <div className="form-group row mt-4">
    <label htmlFor="inputEmail3" className="col-sm-2 col-form-label form-label form-label">Email</label>
    <div className="col-sm-10">
      <input type="email" name='email' className="form-control" id="inputEmail3" placeholder="Email" onChange={handleInput}/>
    </div>
  </div>
  <div className="form-group row mt-4">
    <label htmlFor="inputEmail3" className="col-sm-2 col-form-label form-label form-label">Number</label>
    <div className="col-sm-10">
      <input type="text" name='number' className="form-control" id="inputEmail3" placeholder="Number" onChange={handleInput}/>
    </div>
  </div>
  <div className="form-group row mt-4">
    <label htmlFor="inputEmail3" className="col-sm-2 col-form-label form-label form-label">Experience</label>
    <div className="col-sm-10">
      <input type="number" name='experience' className="form-control" id="inputEmail3" placeholder="Experience"onChange={handleInput}/>
    </div>
  </div>
  <div className="form-group row mt-4">
  <label htmlFor="exampleInputEmail1" className='col-sm-2 col-form-label form-label form-label'>Course</label>
    <div className='col-sm-10'>
